...
const FrameWorkPage_03 = ({page}) => {
  ...
  return (
    <div>
       <div className= {page === 3 ? "FrameWorkPageBodyChild":"d-none"}>
                        <div className="FrameWorkPageBodyChildTittle">
                            <h1>How to Configure Organization Structure and Worker Relations</h1>
                        </div>
...
export default FrameWorkPage_03
