...
const FrameWorkPage_02 = ({page}) => {
  ...
  return (
    <div>
       <div className= {page === 2 ? "FrameWorkPageBodyChild":"d-none"}>
                        <div className="FrameWorkPageBodyChildTittle">
                            <h1 style={{fontWeight:"500"}}>Global Payroll Entity Level Permissions</h1>
                        </div>
...
export default FrameWorkPage_02
