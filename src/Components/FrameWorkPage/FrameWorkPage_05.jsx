...
const FrameWorkPage_05 = ({page}) => {
  ...
  return (
    <div>
       <div className= {page === 5 ? "FrameWorkPageBodyChild":"d-none"}>
                        <div className="FrameWorkPageBodyChildTittle">
                            <h1>How to Create Groups and Add Group Admins</h1>
                        </div>
...
export default FrameWorkPage_05
