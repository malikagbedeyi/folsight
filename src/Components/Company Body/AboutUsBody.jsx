  ...
  return (
    <div className='about-usBody'>
          ...
          <div className="row aboutUs-bodyContainer">
            ...
            <div className="col-lg-6 col-md-12 aboutUs-bodyParent">
              <div className="bodyChildright">
                ...
                <p>Establishing a global premier Trust Management Platform, folsight was created on a mission to rebuild confidence with web-based companies by empowering them to improve and display their security. At Folsight, we’re redefining the IT Audit and Governance, Risk, and Compliance (GRC) solutions landscape. </p>
                 <p>  Founded with a passion for empowering businesses to thrive in the digital age, we believe that robust IT governance and comprehensive risk management are the cornerstones of success. Folsight has initiated an effort to revolutionize risk professions, eliminate vulnerability gaps, and promote audit, risk, and compliance teams to a more proactive   position of impact within their organizations.</p>
      ...
      <div className="about-us-middleContainer">
          <div className="container">
            <div className="aboutUs-middleTIttle">
             <h1>Who We Are</h1>
             <p>Folsight is a leading IT Audit and Governance, Risk, and Compliance (GRC) platform designed to help organizations navigate the intricate landscape of IT governance. By providing innovative, data-driven solutions, we enable businesses to operate securely and compliantly, minimizing risks and ensuring adherence to regulatory standards.</p>
            </div>
          <div className="row aboutUs-middleBody">
            <div className="col-lg-4 col-md-6 aboutUs-middleParent">
              <div className="aboutUs-middleChild">
                ...
                <p>Internet safety has grown tremendously important, we realized how challenging it would be for companies with rapid expansion to dedicate the energy and time required to build a good security framework, our mission is to empower organizations with the tools and insights needed to transform IT governance and risk management. Through our comprehensive suite of solutions, we aim to enhance operational efficiency, elevate compliance standards, and foster a culture of proactive risk management.</p>
             </div>
              </div>
              </div>
              ...
              <div className="aboutUs-middleChild activeChild">
                ...
                <h4>Our Vision</h4>
                <div className="icons-text">
                <p>We envision a future where businesses leverage advanced technology to drive success and innovation in a secure, compliant, and efficient manner. By fostering an environment of transparency and accountability, we strive to build a world where organizations can focus on achieving their strategic goals. Our vision has been consistent since our inception with the goal of integrating security monitoring for regulations such as SOC 2, HIPAA, and ISO 27001.</p>
              </div>
              </div>
              </div>
